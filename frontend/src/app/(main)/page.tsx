                    ...
                    <div className="bg-secondbackground rounded-2xl p-[10px]">
                        <div className="bg-background p-[40px] rounded-full">
                            <svg className="fill-foreground w-[90px]" viewBox="0 0 123 123">
                                ...
                                <path fillRule="evenodd" clipRule="evenodd" d="M91.782 66.7624C94.5968 66.7624 96.8784 69.0508 96.8784 71.8739V92.3198C96.8784 95.1429 94.5968 97.4313 91.782 97.4313H71.3964C68.5817 97.4313 66.3 95.1429 66.3 92.3198V71.8739C66.3 69.0508 68.5817 66.7624 71.3964 66.7624H91.782ZM76.4928 79.5411C76.4928 78.1298 77.6339 76.9854 79.041 76.9854H84.1374C85.5445 76.9854 86.6856 78.1298 86.6856 79.5411V84.6526C86.6856 86.0639 85.5445 87.2083 84.1374 87.2083H79.041C77.6339 87.2083 76.4928 86.0639 76.4928 84.6526V79.5411Z"/>
                                ...
                                <path d="M71.3964 41.205C68.5817 41.205 66.3 43.4935 66.3 46.3165V51.428C66.3 54.251 68.5817 56.5395 71.3964 56.5395C74.2112 56.5395 76.4928 54.251 76.4928 51.428V46.3165C76.4928 43.4935 74.2112 41.205 71.3964 41.205Z"/>
                                ...
                                <path d="M51.0108 87.2083C48.1961 87.2083 45.9144 89.4968 45.9144 92.3198C45.9144 95.1429 48.1961 97.4313 51.0108 97.4313C53.8255 97.4313 56.1072 95.1429 56.1072 92.3198C56.1072 89.4968 53.8255 87.2083 51.0108 87.2083Z"/>
                            </svg>
                        </div>
                    </div>
                </button>
