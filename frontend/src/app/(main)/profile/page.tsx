                ...
                <div className="m-3">
                    <div className="flex justify-between bg-secondbackground p-3 rounded-2xl gap-6">
                        ...
                        <div className="flex flex-col gap-1.5">
                            ...
                            <p className="text-lg font-medium text-gray-300 text-center">Первые шаги</p>
                        </div>
                        <div className="flex flex-col gap-1.5">
                            <svg className="aspect-auto" height="75" viewBox="0 0 169 104" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
                            ...
                            <p className="text-lg font-medium text-gray-300 text-center">...</p>
                        </div>
                        <div className="flex flex-col gap-1.5">
                            <svg className="aspect-auto" height="75" viewBox="0 0 169 104" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div className="flex flex-col gap-1.5">
                            ...
                            <p className="text-lg font-medium text-gray-300 text-center">Легенда</p>
                        </div>
                    </div>
                    <div className="flex justify-between p-3 rounded-2xl gap-6 px-16">
